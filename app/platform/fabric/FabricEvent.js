...
class FabricEvent {
    ...
    async initialize() {
        ...
        logger.debug("Successfully created peer event hub for client [%s]", this.client.client_name);
        ...
        for (var [channel_name, channel] of channels.entries()) {
            ...
            logger.debug("Successfully created channel event hub for  [%s]", channel_name);
        }
    ...
    createPeerEventHub() {
        ...
        this.peerEventHub = this.client.hfc_client.getEventHub(this.client.defaultPeer.getName());
    ...
    async synchBlocks() {
        ...
        let channels = await this.client.getHFC_Client().queryChannels(this.client.getDefaultPeer().getName(), true);
