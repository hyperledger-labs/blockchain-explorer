...
export const getCurrentChannel = (state) => (state.charts.channel.currentChannel);
...
export const getTransactionByOrg = (state) => (state.charts.transactionByOrg.rows);
export const getTransactionList = (state) => (state.tables.transactionList.rows);
export const getTransactionPerMin = (state) => (state.charts.transactionPerMin);
export const getTransactionPerHour = (state) => (state.charts.transactionPerHour);
